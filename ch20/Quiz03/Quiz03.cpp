//solution for Quiz2003.
//我们简单地将光源换为聚光灯即可. 此时需要在像素着色器中判断当前像素的光照是否已经衰减为0
...
#pragma region Quiz2002
    //我们添加一个纹理寻址模式. 在该模式中, 超出边缘的部分都将被采样为透明
...
#pragma region Quiz2001
    ...
    */
    ...
    mProjectorLight.Position = { 0.0f, 2.0f, -10.0f };
