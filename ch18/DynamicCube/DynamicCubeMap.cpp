//copy of DynamicCubeMapApp by Frank Luna, ch18
//evoluted from ch18, CubeMap
/*
 * 对于静态的天空盒/立方体图
 * 我们只需要在外部创建好立方体纹理后
 * LoadTexture
...
private:
	//ch1802, 重写创建Rtv和Srv的方法。我们需要添加动态立方体图所需要的描述符
...
void DynamicCubeMap::UpdateObjectCBs(const GameTimer& gt)
{
