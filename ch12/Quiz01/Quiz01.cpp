...
#pragma region Quiz1201
	...
	circlePsoDesc.PrimitiveTopologyType = D3D12_PRIMITIVE_TOPOLOGY_TYPE_POINT;
	circlePsoDesc.InputLayout = { mCircleInputLayout.data(), (UINT)mTreeSpriteInputLayout.size() };
