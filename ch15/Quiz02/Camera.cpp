...
DirectX::XMVECTOR Camera::GetPostion() const
{
...
void Camera::SetPostion(const DirectX::XMFLOAT3& v)
{
	mPosition = v;
	mViewDirty = true;
}
...
DirectX::XMFLOAT4X4 Camera::GetProj4x4() const
{
	return mProj;
}
...
#pragma region Quiz1502
void Camera::Roll(float angle)
{
	//准备旋转
	//roll的时候，mLook不变, up和right变了 我们先变right
