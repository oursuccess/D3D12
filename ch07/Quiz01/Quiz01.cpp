...
class Quiz01 : public D3DApp
{
public:
	Quiz01(HINSTANCE hInstance);
	Quiz01(const Quiz01& rhs) = delete;
	Quiz01& operator=(const Quiz01& rhs) = delete;
	~Quiz01();
...
private:
	...
	std::unique_ptr<MeshGeometry> mQuiz01Geo = nullptr;
...
Quiz01::Quiz01(HINSTANCE hInstance) : D3DApp(hInstance)
{
}
...
void Quiz01::Update(const GameTimer& gt)
{
	OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void Quiz01::Draw(const GameTimer& gt)
{
...
void Quiz01::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void Quiz01::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void Quiz01::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void Quiz01::OnKeyboardInput(const GameTimer& gt)
{
...
void Quiz01::UpdateCamera(const GameTimer& gt)
{
...
void Quiz01::UpdateObjectCBs(const GameTimer& gt)
{
...
void Quiz01::UpdateMainPassCB(const GameTimer& gt)
{
...
//创建常量堆
void Quiz01::BuildDescriptorHeaps()
{
...
void Quiz01::BuildConstantBufferViews()
{
	//计算该常量缓冲区的大小
...
//创建根签名
void Quiz01::BuildRootSignature()
{
	//创建一个有一个元素的根参数
...
//创建Shader并创建输入布局
void Quiz01::BuildShadersAndInputLayout()
{
	HRESULT hr = S_OK;
...
//构建顶点数据
void Quiz01::BuildQuiz01Geometry()
{
	GeometryGenerator geoGen;
	GeometryGenerator::MeshData box = geoGen.CreateBox(1.5f, 0.5f, 1.5f, 3);
	GeometryGenerator::MeshData grid = geoGen.CreateGrid(20.0f, 30.0f, 60, 40);
#pragma region Quiz0701
...
void Quiz01::BuildFrameResources()
{
...
void Quiz01::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
	UINT objCBByteSize = d3dUtil::CalcConstantBufferByteSize(sizeof(ObjectConstants));
