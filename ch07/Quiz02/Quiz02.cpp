...
private:
	...
	std::unique_ptr<MeshGeometry> mQuiz02Geo = nullptr;
...
void Quiz02::OnKeyboardInput(const GameTimer& gt)
{
...
void Quiz02::UpdateCamera(const GameTimer& gt)
{
...
//构建顶点数据
void Quiz02::BuildQuiz02Geometry()
{
...
void Quiz02::BuildFrameResources()
{
...
void Quiz02::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
	UINT objCBByteSize = d3dUtil::CalcConstantBufferByteSize(sizeof(ObjectConstants));
