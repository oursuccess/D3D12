...
private:
	int mNumRows = 0, mNumCols = 0, mVertexCount = 0, mTriangleCount = 0;
	float mK1 = 0.0f, mK2 = 0.0f, mK3 = 0.0f;
	float mTimeStep = 0.0f, mSpatialStep = 0.0f;

	std::vector<DirectX::XMFLOAT3> mPrevSolution, mCurrSolution, mNormals, mTangentX;
};
