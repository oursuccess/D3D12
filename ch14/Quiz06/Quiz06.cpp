...
void BezierPatch::Update(const GameTimer& gt)
{
    OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void BezierPatch::Draw(const GameTimer& gt)
{
...
void BezierPatch::OnKeyboardInput(const GameTimer& gt)
{
}
 
void BezierPatch::UpdateCamera(const GameTimer& gt)
{
...
void BezierPatch::AnimateMaterials(const GameTimer& gt)
{

}

void BezierPatch::UpdateObjectCBs(const GameTimer& gt)
{
...
void BezierPatch::UpdateMaterialCBs(const GameTimer& gt)
{
...
void BezierPatch::UpdateMainPassCB(const GameTimer& gt)
{
...
void BezierPatch::BuildShadersAndInputLayout()
{
...
void BezierPatch::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 6> BezierPatch::GetStaticSamplers()
{
