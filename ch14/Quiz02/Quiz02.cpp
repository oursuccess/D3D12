...
BezierTessellation::BezierTessellation(HINSTANCE hInstance) : D3DApp(hInstance)
{
}
...
void BezierTessellation::OnKeyboardInput(const GameTimer& gt)
{
}

void BezierTessellation::UpdateCamera(const GameTimer& gt)
{
	mEyePos.x = mRadius * sinf(mPhi) * cosf(mTheta);
	mEyePos.z = mRadius * cosf(mPhi) * sinf(mTheta);
...
void BezierTessellation::AnimateMaterials(const GameTimer& gt)
{
}

void BezierTessellation::UpdateObjectCBs(const GameTimer& gt)
{
	...
	for (auto& e : mAllRitems)
	{
		if (e->NumFramesDirty > 0)
		{
			...
			XMMATRIX trexTransform = XMLoadFloat4x4(&e->TexTransform);

			ObjectConstants objConstants;
			XMStoreFloat4x4(&objConstants.World, XMMatrixTranspose(world));
			XMStoreFloat4x4(&objConstants.TexTransform, XMMatrixTranspose(trexTransform));
...
void BezierTessellation::UpdateMaterialCBs(const GameTimer& gt)
{
...
void BezierTessellation::UpdateMainPassCB(const GameTimer& gt)
{
...
void BezierTessellation::LoadTextures()
{
...
void BezierTessellation::BuildRootSignature()
{
...
void BezierTessellation::BuildDescriptorHeaps()
{
...
void BezierTessellation::BuildShaderAndInputLayout()
{
...
void BezierTessellation::BuildQuadPatchGeometry()
{
	...
	*/
	...
	auto geoSphere = geoGen.CreateGeosphere(5, 0);

	std::vector<XMFLOAT3> vertices;
	for (auto& vert : geoSphere.Vertices) 
	{
		vertices.push_back(vert.Position);
	}
	auto indices = geoSphere.GetIndices16();
	...
	quadSubmesh.IndexCount = geoSphere.Indices32.size();
...
void BezierTessellation::BuildPSOs()
{
...
void BezierTessellation::BuildFrameResources()
{
...
void BezierTessellation::BuildMaterials()
{
...
void BezierTessellation::BuildRenderItems()
{
...
void BezierTessellation::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*> ritems)
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 6> BezierTessellation::GetStaticSamplers()
{
