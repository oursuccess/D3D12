...
class CSMApp : public D3DApp
{
public:
	CSMApp(HINSTANCE hInstance);	//构造函数
	CSMApp(const CSMApp& rhs) = delete;
	CSMApp& operator=(const CSMApp& rhs) = delete;
	~CSMApp();	//析构函数
...
CSMApp::CSMApp(HINSTANCE hInstance) :
	D3DApp(hInstance)
{
...
void CSMApp::CreateRtvAndDsvDescriptorHeaps()
{
...
void CSMApp::Update(const GameTimer& gt)
{
...
void CSMApp::Draw(const GameTimer& gt)
{
...
void CSMApp::OnMouseDown(WPARAM btnState, int x, int y)
{
...
void CSMApp::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();	//接触画面的定格
}

void CSMApp::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void CSMApp::OnKeyboardInput(const GameTimer& gt)
{
...
void CSMApp::AnimateMaterials(const GameTimer& gt)
{
}
...
void CSMApp::UpdateSkinnedCBs(const GameTimer& gt)
{
...
void CSMApp::UpdateMaterialBuffer(const GameTimer& gt)
{
...
void CSMApp::UpdateShadowTransform(const GameTimer& gt)
{
...
void CSMApp::UpdateMainPassCB(const GameTimer& gt)
{
...
void CSMApp::UpdateShadowPassCB(const GameTimer& gt)
{
...
void CSMApp::UpdateSsaoCB(const GameTimer& gt)
{
...
void CSMApp::BuildRootSignature()
{
...
void CSMApp::BuildSsaoRootSignature()
{
	CD3DX12_DESCRIPTOR_RANGE texTable0;
...
void CSMApp::BuildDescriptorHeaps()
{
...
void CSMApp::BuildShadersAndInputLayout()
{
...
void CSMApp::BuildShapeGeometry()
{
...
void CSMApp::BuildFrameResources()
{
...
void CSMApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
...
void CSMApp::DrawSceneToShadowMap()
{
...
void CSMApp::DrawNormalsAndDepth()
{
...
CD3DX12_CPU_DESCRIPTOR_HANDLE CSMApp::GetCpuSrv(int index) const
{
...
CD3DX12_GPU_DESCRIPTOR_HANDLE CSMApp::GetGpuSrv(int index) const
{
...
CD3DX12_CPU_DESCRIPTOR_HANDLE CSMApp::GetDsv(int index) const
{
...
CD3DX12_CPU_DESCRIPTOR_HANDLE CSMApp::GetRtv(int index) const
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 7> CSMApp::GetStaticSamplers()
{
