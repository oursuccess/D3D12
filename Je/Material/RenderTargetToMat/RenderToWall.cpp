...
class RenderToWallApp : public D3DApp
{
public:
    RenderToWallApp(HINSTANCE hInstance);
    RenderToWallApp(const RenderToWallApp& rhs) = delete;
    RenderToWallApp& operator=(const RenderToWallApp& rhs) = delete;
    ~RenderToWallApp();
    ...
    PSTR cmdLine, int showCmd)
{
    ...
    try
    {
        RenderToWallApp theApp(hInstance);
...
RenderToWallApp::RenderToWallApp(HINSTANCE hInstance)
    : D3DApp(hInstance)
{
}

RenderToWallApp::~RenderToWallApp()
{
    if(md3dDevice != nullptr)
        FlushCommandQueue();
}

bool RenderToWallApp::Initialize()
{
...
void RenderToWallApp::Update(const GameTimer& gt)
{
    OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void RenderToWallApp::Draw(const GameTimer& gt)
{
...
void RenderToWallApp::OnMouseDown(WPARAM btnState, int x, int y)
{
    mLastMousePos.x = x;
    mLastMousePos.y = y;
...
void RenderToWallApp::OnMouseUp(WPARAM btnState, int x, int y)
{
    ReleaseCapture();
}

void RenderToWallApp::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void RenderToWallApp::OnKeyboardInput(const GameTimer& gt)
{
	//
...
void RenderToWallApp::UpdateCamera(const GameTimer& gt)
{
...
void RenderToWallApp::AnimateMaterials(const GameTimer& gt)
{

}

void RenderToWallApp::UpdateObjectCBs(const GameTimer& gt)
{
...
void RenderToWallApp::UpdateMaterialCBs(const GameTimer& gt)
{
...
void RenderToWallApp::UpdateMainPassCB(const GameTimer& gt)
{
...
void RenderToWallApp::UpdateReflectedPassCB(const GameTimer& gt)
{
...
void RenderToWallApp::LoadTextures()
{
...
void RenderToWallApp::BuildRootSignature()
{
...
void RenderToWallApp::BuildDescriptorHeaps()
{
	//
	// Create the SRV heap.
	//
...
void RenderToWallApp::BuildShadersAndInputLayout()
{
...
void RenderToWallApp::BuildRoomGeometry()
{
...
void RenderToWallApp::BuildSkullGeometry()
{
...
void RenderToWallApp::BuildPSOs()
{
...
void RenderToWallApp::BuildMaterials()
{
...
void RenderToWallApp::BuildRenderItems()
{
...
void RenderToWallApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 6> RenderToWallApp::GetStaticSamplers()
{
