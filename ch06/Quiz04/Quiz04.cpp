...
{
#pragma region Quiz0604
	//顶点
	std::array<Vertex, 5> vertices = //change size from 8 to 5
	{
		//懒得修改塔底了，需要的话将后面的Colors统一替换成Green即可
	...
	//索引
	std::array<std::uint16_t, 18> indices = //change size from 36 to 18
	{
		/*
		//front face
		0, 1, 2,
