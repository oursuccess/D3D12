...
void Box::BuildShadersAndInputLayout()
{
	...
	//读取shader
	mvsByteCode = d3dUtil::CompileShader(L"Shaders\\color0606.hlsl", nullptr, "VS06", "vs_5_0");
	mpsByteCode = d3dUtil::CompileShader(L"Shaders\\color0606.hlsl", nullptr, "PS", "ps_5_0");
