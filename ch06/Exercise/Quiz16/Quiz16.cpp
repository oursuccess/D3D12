...
#pragma region Quiz0616
	XMFLOAT4 gPulseColor = XMFLOAT4(1, 1, 1, 1);
	float gTime = 0.0f;
#pragma endregion
};
...
#pragma region Quiz0616
	...
	objConstants.gPulseColor = { max(sin(objConstants.gTime), 0), max(cos(objConstants.gTime), 0), max(cos(objConstants.gTime * 4), 0), 1 };
#pragma endregion
