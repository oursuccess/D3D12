...
#pragma region Quiz1108
	...
	//depthTestStencilDesc.DepthWriteMask = D3D12_DEPTH_WRITE_MASK_ZERO;	//这儿一定要禁止深度写入 是因为我们之前错误的在深度测试中继承了这个，而其也写入了深度...
	...
	//depthTestStencilDesc.FrontFace.StencilDepthFailOp = D3D12_STENCIL_OP_DECR_SAT;
	...
	//depthTestStencilDesc.BackFace.StencilDepthFailOp = D3D12_STENCIL_OP_DECR_SAT;
	...
	depthDrawStencilDesc.DepthEnable = false;
