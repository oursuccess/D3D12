//solution for quiz1302

//copy of VecLen by Frank Luna, ch13
...
#pragma endregion
	...
	{
		fout << "(" << mappedData[i].len << ")" << std::endl;
	}
...
#pragma region Quiz1302
	...
	for (int i = 0; i < NumDataElements; ++i)
	{
		data[i].pos = XMFLOAT3(rand() % 20 - 10, rand() % 20 - 10, rand() % 20 - 10);
	}
