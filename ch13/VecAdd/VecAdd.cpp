//copy of VecAdd by Frank Luna, ch13
...
VecAddCS::VecAddCS(HINSTANCE hInstance) : D3DApp(hInstance)
{
}
...
void VecAddCS::BuildBuffers()
{
	...
	mInputBufferA = d3dUtil::CreateDefaultBuffer(md3dDevice.Get(), mCommandList.Get(), dataA.data(),
		byteSize, mInputUploadBufferA);
	mInputBufferB = d3dUtil::CreateDefaultBuffer(md3dDevice.Get(), mCommandList.Get(), dataB.data(),
		byteSize, mInputUploadBufferB);
...
void VecAddCS::BuildDescriptorHeaps()
{
}
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 6> VecAddCS::GetStaticSamplers()
{
